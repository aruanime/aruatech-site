  ...
  return (
    ...
    >
      ...
      <span className="flex min-w-0 flex-col justify-center leading-none">
        <span className="font-heading text-[1.2rem] font-semibold tracking-[0.1em] text-navy sm:text-[1.5rem] sm:tracking-[0.12em]">
          {SITE.shortName}
        </span>
        {!compact ? (
          <span className="mt-1 hidden text-[0.58rem] font-medium tracking-[0.22em] text-navy/70 uppercase sm:block">
            {SITE.tagline}
          </span>
        ) : null}
      </span>
